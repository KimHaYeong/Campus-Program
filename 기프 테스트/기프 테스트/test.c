...
//		case 3:
//			return;
//		default: printf("Àß¸øÀÔ·ÂÇÏ¼Ì½À´Ï´Ù.\n");
//		}
//	}
//
//}
...
//	printf("¦­                                                              ¦­\n");
//	printf("¦­                                   ½Ã                         ¦­\n");
//	gotoxy(20, 8); printf("½ÃÀÛ½Ã°£ :  "); scanf("%d", &add->StartTime);
//	printf("¦­                                                              ¦­\n");
//	printf("¦­                                   ½Ã                         ¦­\n");
//	gotoxy(20, 10); printf("Á¾·á½Ã°£ :  "); scanf("%d", &add->EndTime);
//	printf("¦­                                                              ¦­\n");
//	printf("¦­                                                              ¦­\n");
//	printf("¦­                                                              ¦­\n");
//	printf("¦±¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦°\n");
...
//		}
//		if (hour == 24) return 0;
//		sprintf(nowtime, "title ÇöÀç ½Ã°£ %d%s %d%s %d%s", hour, t1, minitue, t2, second, t3);
//		system(nowtime);
//
//	}
//}
//
//int gotoxy(int x, int y) //x,y À§Ä¡·Î drawÀ§Ä¡ º¯°æ
//{
